...
public class FoodProcessorScreen extends ICContainerScreen<FoodProcessorMenu> {
    private static final ResourceLocation TEXTURE = Resource.texture("gui/food_processor.png");

    public FoodProcessorScreen(FoodProcessorMenu menu, Inventory playerInventory, Component title) {
