...
public class FoodFermenterShape extends MultiblockShape {
    ...
    private static final List<AABB> BODY_SHAPE = List.of(
            ...
            new AABB(-1.25,   0.1875, -1.5,     -0.75,  0.6875, -1.4375),
            new AABB(-1.125,  0.75,   -1.5,     -0.875, 1,      -1.4375),
            new AABB( 0.4375, 0.9375, -0.625,    0.5,   1.1875, -0.375),
            new AABB(-1.5,    0.1875, -0.25,    -1.4375, 0.6875,  0.25),
            new AABB(-1.5,    0.1875, -1.25,    -1.4375, 0.6875, -0.75),
            new AABB(-1.5,    0.75,   -1.125,   -1.4375, 1,      -0.875),
            new AABB(-1.5,    0.75,   -0.125,   -1.4375, 1,       0.125),
