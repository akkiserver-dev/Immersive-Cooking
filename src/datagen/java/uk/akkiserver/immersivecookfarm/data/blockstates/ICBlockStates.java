package uk.akkiserver.immersivecookfarm.data.blockstates;
...
import uk.akkiserver.immersivecookfarm.common.blocks.multiblocks.ICTemplateMultiblock;
...
public class ICBlockStates extends BlockStateProvider {
    ...
    public ICBlockStates(PackOutput output, ExistingFileHelper exFileHelper) {
        super(output, ImmersiveCookFarm.MODID, exFileHelper);
